const cmdb_zh = {
    ...
    preference: {
        ...
        tips2: ' 我的订阅 ',
        tips3: '页面完成订阅!',
        syncRelationAttrs: '同名属性回填',
        syncingRelationAttrs: '回填中，请稍候...',
        syncRelationAttrsConfirm: '将对该模型下所有已关联的配置项执行同名属性回填，是否继续？',
        syncRelationAttrsSuccess: '回填完成，共更新 {updated} 个属性值',
        syncRelationAttrsConflict: '回填完成，更新 {updated} 个属性值，发现 {conflicts} 个冲突（两方均不为空且值不同），详见后台日志',
        syncRelationAttrsFailed: '回填失败，请检查后台日志',
    },
    custom_dashboard: {
        charts: '图表',
        newChart: '新增图表',
...
if __name__ == "__main__":
    ...
    ipam: {
        ...
        scanNow: '立即扫描',
        scanningTip: '扫描任务已在后台运行，请稍候',
        scanConfirmTip: '确认要对 {cidr} 执行 IP 在线探测？',
        scanStartedTip: '扫描任务已提交，后台执行中，稍后刷新查看结果',
        scanFailedTip: '扫描任务提交失败',
    },
    dcim: {
        addRegion: '新增区域',
        addIDC: '新增数据中心',
