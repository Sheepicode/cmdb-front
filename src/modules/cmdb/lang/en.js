const cmdb_en = {
    ...
    preference: {
        ...
        syncRelationAttrs: 'Sync Same-name Attrs',
        syncingRelationAttrs: 'Syncing, please wait...',
        syncRelationAttrsConfirm: 'This will backfill same-name attributes for all related CIs of this type. Continue?',
        syncRelationAttrsSuccess: 'Done, {updated} attribute(s) updated',
        syncRelationAttrsConflict: 'Done, {updated} updated, {conflicts} conflict(s) found (both non-empty but different), see backend logs',
        syncRelationAttrsFailed: 'Sync failed, please check backend logs',
    },
    custom_dashboard: {
        charts: 'Chart',
        newChart: 'Add Chart',
...
if __name__ == "__main__":
    ...
    ipam: {
        ...
        scanNow: 'Scan Now',
        scanningTip: 'Scan task is already running in background',
        scanConfirmTip: 'Confirm to scan {cidr} for online IPs?',
        scanStartedTip: 'Scan task submitted, running in background',
        scanFailedTip: 'Failed to submit scan task',
    },
    dcim: {
