...
const genCmdbRoutes = async () => {
  const routes = {
    ...
    children: [
      ...
      {
        path: '/cmdb/adc_diff',
        name: 'cmdb_auto_discovery_ci_diff',
        meta: { title: '配置发现池', icon: 'ops-cmdb-adc', selectedIcon: 'ops-cmdb-adc', keepAlive: false },
        component: () => import('../views/discoveryCIDiff/index.vue')
      },
      {
        path: '/cmdb/adc_relaction',
        name: 'cmdb_auto_discovery_ci_relation',
        meta: { title: '关系发现池', icon: 'ops-cmdb-relation', selectedIcon: 'ops-cmdb-relation', keepAlive: false },
        component: () => import('../views/discoveryCIRelation/index.vue')
      },
      {
